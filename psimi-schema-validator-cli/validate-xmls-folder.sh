...
#SBATCH -J "XML_VALIDATOR"   # job name
#SBATCH -o "/nfs/production/hhe/intact/data/psi-mi-validator-logs/validate-xml-%j.out"   # job output file
...
do
  ...
  echo "mvn -U clean install -Pvalidate -Dfile="$FILE" -Dscope=syntax -Dlevel=WARN -Dmaven.test.skip"
