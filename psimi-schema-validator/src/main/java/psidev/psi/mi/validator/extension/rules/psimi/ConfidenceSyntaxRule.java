        ...
        if (confidence != null){
            ...
            if (type == null ||
                ...
                if (dbTerm == null){
                    ...
                    messages.add( new ValidatorMessage( "The confidence type MI identifier "+type.getMIIdentifier()+"  does not exist in the PSI-MI ontology. The valid MI terms for confidence types are available here: https://www.ebi.ac.uk/ols4/ontologies/mi/terms?obo_id=MI:1064",
                            MessageLevel.ERROR,
                            context,
                            this ) );
                }
                    ...
                    if (!foundParent){
                        ...
                        messages.add( new ValidatorMessage( "The MI identifier "+type.getMIIdentifier()+" is not a valid MI identifier for confidence types. The valid MI terms for confidence types are available here: https://www.ebi.ac.uk/ols4/ontologies/mi/terms?obo_id=MI:1064",
                                MessageLevel.ERROR,
                                context,
                                this ) );
                    }
