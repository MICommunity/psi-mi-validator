        ...
        if (checksum != null){
            ...
            if (method == null ||
                ...
                if (dbTerm == null){
                    ...
                    messages.add( new ValidatorMessage( "The checksum method MI identifier "+method.getMIIdentifier()+"  does not exist in the PSI-MI ontology. The valid MI terms for checksum methods are available here: https://www.ebi.ac.uk/ols4/ontologies/mi/terms?obo_id=MI:1212",
                            MessageLevel.ERROR,
                            context,
                            this ) );
                }
                    ...
                    if (!foundParent){
                        ...
                        messages.add( new ValidatorMessage( "The MI identifier "+method.getMIIdentifier()+" is not a valid MI identifier for checksum methods. The valid MI terms for checksum methods are available here: https://www.ebi.ac.uk/ols4/ontologies/mi/terms?obo_id=MI:1212",
                                MessageLevel.ERROR,
                                context,
                                this ) );
                    }
